...
class Publish extends BaseCommand {
  ...
  protected function publishEntities() {
    ...
    $content = file_get_contents($path);
    $content = $this->replaceNamespace($content, 'App\Entities', 'Entities');
  ...
  protected function publishController() {
    ...
    $content = file_get_contents($path);
    $content = $this->replaceNamespace($content, 'App\Controllers', 'Controllers');
  ...
  protected function publishView($view, string $prefix = '') {
    ...
    $content = file_get_contents($path);
    $content = str_replace('App\Views', $namespace . '\Auth', $content);
  ...
  protected function publishFilters() {
    ...
    foreach ($filters as $filter) {
      ...
      $content = file_get_contents($path);
      $content = $this->replaceNamespace($content, 'App\Filters', 'Filters');
  ...
  protected function publishMigration() {
    ...
    foreach ($map as $file) {
      ...
      $content = $this->replaceNamespace($content, 'App\Database\Migrations', 'Database\Migrations');
  ...
  protected function publishConfig() {
    ...
    if ($this->viewsPublished) {
      $namespace = defined('APP_NAMESPACE') ? APP_NAMESPACE : 'App';
      $content = str_replace('App\Views', $namespace . '\Views', $content);
    }
