    ...
    if (has_permissions([
      ...
      $adminMenu = [
        ...
        'dropdown' => [
          ...
          [ 'url' => base_url() . 'license', 'icon' => 'bi bi-vector-pen', 'label' => lang('Navbar.administration.license'), 'permitted' => has_permissions('application.manage') ],
          [ 'url' => base_url() . 'phpinformation', 'icon' => 'bi bi-filetype-php', 'label' => lang('Navbar.administration.phpinfo'), 'permitted' => has_permissions('application.manage') ],
          [ 'url' => base_url() . 'settings', 'icon' => 'bi bi-gear', 'label' => lang('Navbar.administration.settings'), 'permitted' => has_permissions('application.manage') ],
        ]
      ];
    ...
    <li class="sidebar-item">
      ...
      <ul id="user" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
        ...
        if (!logged_in()) {
          ...
          echo $bs->sidebarSublink([ 'url' => base_url() . 'logout', 'icon' => 'bi bi-box-arrow-left', 'label' => lang('Navbar.user.setup2fa'), 'permitted' => true ]);
        } ?>
      </ul>
    </li>
