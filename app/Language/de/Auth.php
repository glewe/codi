...
return [
  ...
  '2fa' => [
    ...
    'setup' => [
      ...
      'secret_exists_not_required' => 'Du hast deine 2FA schon eingerichtet. Wenn du es erneut tust, wird dein alter Schl&uuml;ssel &uuml;berschrieben. Authenticator App Eintr&auml;ge, die auf dem alten Schl&uuml;ssel basieren, werden dann nicht mehr funktionieren.<br>Da 2FA optional ist, kannst du deinen Schlüssel hier auch wieder löschen.',
  ...
  'exception' => [
    ...
    'password_length_not_set' => 'Der Wert `minimumPasswordLength` muss in der Auth Config Datei gesetzt sein.',
  ...
  'forgot' => [
    ...
    'reset_success' => 'Dein Passwort wurde erfolgreich ge&auml;ndert. Bitte log dich mit dem neuen Passwort ein.',
  ...
  'login' => [
    ...
    'logout_success' => 'Du wurdest erfolgreich ausgeloggt.',
  ...
  //
  'profile' => [
    'update_success' => 'Das Profil von "{0} ({1})" wurde erfolgreich aktualisiert.',
  ],
  ...
  'role' => [
    'bscolor' => 'Rollenfarbe',
    'bscolor_desc' => 'Rollen Icons werden entsprechend der gewählten Farbe dargestellt.',
  ...
  'user' => [
    ...
    'hidden' => 'Im Kalender verbergen',
    'hidden_desc' => 'Mit diesem Schalter kannst du den Benutzer im Kalender verbergen. Dies kann für administrative Benutzer nützlich sein.',
    'inactive' => 'Inaktiv',
    ...
    'remove_secret_confirm_desc' => 'Bist du sicher, dass du den 2FA Schl&uuml;ssel f&uuml;r diesen Benutzer entfernen willst? Der Benutzer kann einen neuen anlegen, indem er den 2FA Einrichtungsprozess neu durchf&uuml;hrt.',
