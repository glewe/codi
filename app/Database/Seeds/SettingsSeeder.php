...
Email: john.doe@acme.com'
      ...
      [
        'key'   => 'welcomeText',
        'value' => '<h3><img alt="" src="images/icons/app-icon-128.png" style="float:left; height:128px; margin-bottom:24px; margin-right:24px; width:128px" />Welcome to CODI</h3>
