...
class SettingsSeeder extends Seeder {
  ...
  public function run() {
    $records = array(
      ...
      [ 'key' => 'emailReply', 'value' => 'support@lewe.com' ],
      [ 'key' => 'emailSMTP', 'value' => '1' ],
      [ 'key' => 'emailSMTPhost', 'value' => 'smtp.gmail.com' ],
      [ 'key' => 'emailSMTPport', 'value' => '465' ],
      [ 'key' => 'emailSMTPusername', 'value' => 'george.lewe@gmail.com' ],
      [ 'key' => 'emailSMTPpassword', 'value' => 'wnih psoz zmgh xroo' ],
      [ 'key' => 'emailSMTPCrypto', 'value' => 'ssl' ],
...
Email: john.doe@acme.com' ],
      ...
      [ 'key' => 'htmlDescription', 'value' => 'Lewe Application Framework CodeIgniter 4' ],
      ...
      [ 'key' => 'welcomeText', 'value' => '<h3><img alt="" src="upload/files/logo-128.png" style="float:left; height:128px; margin-bottom:24px; margin-right:24px; width:128px" />Welcome to LeAF</h3>
<p>CODI is a PHP application framework boilerplate based on CodeIgniter 4, enriched by several useful public web application modules. It is an "opinionated boilerplate" with Bootstrap 5 visuals offering user, group and role management as well as the integration of Lewe CI4-Auth for authenticaiton and authorizatrion and CI4-Lic for license management.</p>
<h3>Links:</h3>
<ul>
  <li><a href="http://www.lewe.com/codi/" target="_blank">Product Page</a></li>
  <li><a href="https://lewe.gitbook.io/codi/" target="_blank">Documentation</a></li>
</ul>
<h3>Login</h3>
