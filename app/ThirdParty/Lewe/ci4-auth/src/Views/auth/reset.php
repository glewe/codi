    ...
    <div class="col-sm-6 offset-sm-3">
      ...
      <div class="card">
        ...
        <div class="card-header">
          <i class="bi-unlock-fill me-2"></i><strong><?= lang('Auth.login.reset_your_password') ?></strong></i>
        ...
        <div class="card-body">
          ...
          <form action="<?= base_url() ?>/reset-password" method="post">
            ...
            <div class="mb-3">
              ...
              <input id="token" type="text" class="form-control <?php if (session('errors.token')) : ?>is-invalid<?php endif ?>" name="token" placeholder="<?= lang('Auth.login.token') ?>" value="<?= old('token', $token ?? '') ?>">
            ...
            <div class="mb-3">
              ...
              <input id="password" type="password" class="form-control <?php if (session('errors.password')) : ?>is-invalid<?php endif ?>" name="password">
              <div class="invalid-feedback">
