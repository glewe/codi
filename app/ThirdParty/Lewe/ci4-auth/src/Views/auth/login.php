          ...
          <form action="<?= base_url() ?>/login" method="post">
            ...
            <?php if ($config->validFields === [ 'email' ]) : ?>
              <div class="mb-3">
                ...
                <input id="login" type="email" class="form-control <?php if (session('errors.login')) : ?>is-invalid<?php endif ?>" name="login" placeholder="<?= lang('Auth.login.email') ?>">
            ...
            <?php else : ?>
              <div class="mb-3">
                ...
                <input id="login" type="text" class="form-control <?php if (session('errors.login')) : ?>is-invalid<?php endif ?>" name="login" placeholder="<?= lang('Auth.login.email_or_username') ?>">
                <div class="invalid-feedback">
                  <?= session('errors.login') ?>
                </div>
              </div>
