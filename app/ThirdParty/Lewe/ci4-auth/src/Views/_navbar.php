...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarTop">
      ...
      <ul class="navbar-nav">
        <?php if (has_permissions([ 'group.view', 'permission.view', 'role.view', 'user.view' ])) { ?>
