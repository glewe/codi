...
class UserModel extends Model {
  ...
  protected $validationRules = [
    'email' => [ 'required', 'valid_email', 'is_unique[auth_users.email,id,{id}]' ],
    'username' => [ 'required', 'alpha_numeric_punct', 'min_length[3]', 'max_length[30]', 'is_unique[auth_users.username,id,{id}]' ],
  ...
  protected $validationMessages = [
    'email' => [
      ...
      'is_unique[auth_users.email,email,{$data["name"]}]' => 'This email address is already taken.',
    ],
    'username' => [
      'required' => 'You must enter a username.',
      'max_length[80]' => 'The username cannot be longer than 80 characters.',
      'is_unique[auth_users.username,username,{$data["username"]}]' => 'This username is already taken.',
    ],
    'firstname' => [
